...
# 📈 Now supports data visualization!
...
# - "Plot sales by month as a bar chart"
...
### giving the graph and table , raw  selection 
#### almost perfect for df method 
####
                ...
                if result is not None:
                    ...
                    if isinstance(result, (matplotlib.figure.Figure, plt.Axes)):
                        ...
                        if isinstance(result, plt.Axes):
                            ...
                            fig = result
                        # Adjust figure size for Streamlit display
